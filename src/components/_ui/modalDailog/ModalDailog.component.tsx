...
export default function ModalDailog({ openModal, closeModal }: any) {
  const handleClose = () => {
    closeModal(false)
  }
  ...
  return (
    <>
      <Dialog open={openModal} TransitionComponent={Transition} keepMounted aria-describedby="alert-dialog-slide-description">
